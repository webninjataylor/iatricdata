...
function insertContact(){
	...
	$query_insertContact = "INSERT INTO tblContacts (title, firstName, lastName, jobTitle, company, address1, address2, city, stateProv, zip, email, phone1, phone2, phone3, modifiedBy)
							VALUES ('".$_POST['title']."', '".$_POST['firstName']."', '".$_POST['lastName']."', '".$_POST['jobTitle']."', '".$_POST['company']."', '".$_POST['address1']."', '".$_POST['address2']."', '".$_POST['city']."', '".$_POST['stateProv']."', '".$_POST['zip']."', '".$_POST['email']."', '".$_POST['phone1']."', '".$_POST['phone2']."', '".$_POST['phone3']."', '".$_POST['email']."');";
...
$to      = 'taylor_johnson@adelphia.net; ';  //Cindy.Steinkamp@IatricData.com
...
$message = $_POST['title'] . " " . $_POST['firstName'] . " " . $_POST['lastName'] . "\n" .
	$_POST['company'] . "\n" .
	$_POST['jobTitle'] . "\n\n" .
	$_POST['address1'] . ", " .
	$_POST['address2'] . "\n" .
	$_POST['city'] . ", " . $_POST['stateProv'] . " " . $_POST['zip'] . "\n\n" .
	$_POST['email'] . "\n" .
	"(" . $_POST['phone1'] . ") " . $_POST['phone2'] . "-" . $_POST['phone3'] . "\n\n" .
	"Is this in regard to: " . $_POST['subject'] . "\n" .
	"Additional Information Regarding Your Project: " . $_POST['additionalInfo'] . "\n" .
	"Sample Type: " . $samples . " " . "\n" .
	"Gender: " . $_POST['gender'] . "\n" .
...
<div id="content" style="width:760px; position:absolute; top:20px; z-index:102; left:50%; margin-left:-380px;"><div id="header"><img src="images/spacer.gif" alt="Spacer" width="760" height="84" style="margin-bottom:4px;" /></div><table width="760" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="760"  border="0" cellspacing="0" cellpadding="0">
    <tr valign="top">
      ...
      <td style="padding-top:20px; padding-left:20px; padding-right:0px;"><p>Thank you for your email.  A copy has been sent to you as a courtesy for your records. We will respond to you in a timely manner.</p>
      </td>
    </tr>
  </table>
  <div id="footer"></div>
